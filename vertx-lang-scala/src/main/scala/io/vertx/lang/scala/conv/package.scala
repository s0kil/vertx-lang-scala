...
/** Creating a package object scala that imports from the scala package is not possible. That's why this class takes
  * care of abstracting the necessary classes/conversions away so we don't have to import from the scala package
  * directly.
  */
package object conv:
